...
def perform_action(action):
    print('performing action start point')
    global script_enabled
    if not script_enabled:
        return
    print('perform action started')
...
def hotkey_pressed(key):
    print('hotkey pressed start point')
    if not script_enabled:
        return
    ...
    with dpg.menu_bar():
        ...
        with dpg.menu(label="settings"):
            ...
            with dpg.menu(label="sounds"):
                dpg.add_menu_item(label="success")
                dpg.add_menu_item(label="error")
                dpg.add_menu_item(label="on")
                dpg.add_menu_item(label="off")
